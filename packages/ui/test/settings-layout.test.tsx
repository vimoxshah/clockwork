 ...
 * defects needed to exist. The pixels were checked separately, in Chromium at
 * 1440px and 430px, against the real stylesheet.
 */
...
describe('the page is one grid, not a stack with two-column islands', () => {
  ...
  it('lets each card be its own height, which is what removed the dead space', () => {
    // A short card sharing a fixed row with a tall one is what left half a
    // screen empty under the limits banner.
