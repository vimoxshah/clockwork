  ...
  return (
    ...
    >
      <span className="flex items-center gap-2">
        ...
        <strong className="text-[13px]">{copy.title}</strong>
      ...
      <p className="m-0 text-[12px] leading-relaxed text-muted">{copy.value}</p>
      <p className="m-0 text-[12px] leading-relaxed text-dim">{message}</p>
